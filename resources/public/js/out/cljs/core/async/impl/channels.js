...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20388 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20388 = (function (val,box,meta20389){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20388.cljs$lang$type = true;
cljs.core.async.impl.channels.t20388.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20388";
cljs.core.async.impl.channels.t20388.cljs$lang$ctorPrWriter = (function (this__9670__auto__,writer__9671__auto__,opt__9672__auto__){return cljs.core._write.call(null,writer__9671__auto__,"cljs.core.async.impl.channels/t20388");
});
cljs.core.async.impl.channels.t20388.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20388.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20390){var self__ = this;
var _20390__$1 = this;return self__.meta20389;
});
cljs.core.async.impl.channels.t20388.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20390,meta20389__$1){var self__ = this;
var _20390__$1 = this;return (new cljs.core.async.impl.channels.t20388(self__.val,self__.box,meta20389__$1));
});
cljs.core.async.impl.channels.__GT_t20388 = (function __GT_t20388(val__$1,box__$1,meta20389){return (new cljs.core.async.impl.channels.t20388(val__$1,box__$1,meta20389));
});
}
return (new cljs.core.async.impl.channels.t20388(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20391 = self__.takes.pop();if((taker_20391 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20391))
{var take_cb_20392 = cljs.core.async.impl.protocols.commit.call(null,taker_20391);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20392,taker_20391,this$__$1){
return (function (){return take_cb_20392.call(null,null);
});})(take_cb_20392,taker_20391,this$__$1))
);
} else
{}
{
