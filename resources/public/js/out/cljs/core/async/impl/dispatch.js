...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20382 = (0);while(true){
var m_20383 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20383 == null))
{} else
{m_20383.call(null);
if((count_20382 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20384 = (count_20382 + (1));
count_20382 = G__20384;
continue;
}
} else
{}
