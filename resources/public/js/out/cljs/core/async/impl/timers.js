...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_20289 = (0);while(true){
if((i_20289 < arr.length))
{(arr[i_20289] = null);
{
...
{var i_20296 = (self__.level + (1));while(true){
if((i_20296 <= (new_level + (1))))
{(update[i_20296] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20298 = (0);while(true){
if((i_20298 <= self__.level))
{var links_20299 = (update[i_20298]).forward;if(((links_20299[i_20298]) === x__$1))
{(links_20299[i_20298] = (x__$1.forward[i_20298]));
{
